...
const ITEMS: NavItem[] = [
  { href: "/", label: "דשבורד", also: ["/talent", "/jobs", "/pipeline", "/employers", "/marketing", "/campaigns"] },
  { href: "/applications", label: "רשומות", also: ["/companies", "/candidates", "/positions", "/payments", "/emails"] },
];
