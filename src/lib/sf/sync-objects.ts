...
export const SYNC_OBJECTS: SyncObjectDef[] = [
  ...
  },
  {
    ...
    table: sfTask,
    cursorField: "SystemModstamp",
    // All fields: the org's own call fields (who the call was with, whether it
    // was answered) are custom and would be missed by a fixed list.
    ...
    toRow: (r) => ({
      ...
      // "צד לשיחה" (candidate / employer / …) and "האם היה מענה" on logged calls.
      callParty: str(r, "Field1__c"),
      callAnswered: typeof r.call_answer__c === "boolean" ? r.call_answer__c : null,
      ownerId: str(r, "OwnerId"),
      createdDate: date(r, "CreatedDate"),
      systemModstamp: date(r, "SystemModstamp"),
      isDeleted: bool(r, "IsDeleted"),
